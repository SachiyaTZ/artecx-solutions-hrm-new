...
<template>
  ...
  >
    ...
    <oxd-text tag="p" class="orangehrm-installer-page-content">
      ...
      user for your ARTecXHRM Instance
    </oxd-text>
    <br />
    ...
    <oxd-form-row class="orangehrm-register-consent">
      <oxd-input-field
        ...
        type="checkbox"
        option-label="Register your system with ARTecXHRM. By registering, You will be eligible for free support via emails, receive security alerts and news letters from ARTecXHRM."
      />
