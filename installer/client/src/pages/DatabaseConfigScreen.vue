    ...
    <oxd-grid :cols="4" class="orangehrm-full-width-grid">
      ...
      >
        <oxd-input-field
          ...
          label="&nbsp;"
          type="checkbox"
          option-label="Use the same Database User for ARTecXHRM"
        />
      </oxd-grid-item>
    </oxd-grid>
    <oxd-grid
    ...
    >
      ...
      <oxd-grid-item>
        <oxd-input-field
          ...
          v-tooltip="
            'ARTecXHRM database user should have the rights to insert data into table, update data in a table, delete data in a table.'
          "
          label="ARTecXHRM Database Username"
      ...
      <oxd-grid-item>
        <oxd-input-field
          ...
          :disabled="disableOHRMDBfield"
          label="ARTecXHRM Database User Password"
          type="password"
        />
      </oxd-grid-item>
    </oxd-grid>
