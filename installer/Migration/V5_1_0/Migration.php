...
class Migration extends AbstractMigration
{
    ...
    private function modifyThemeTable(): void
    {
        ...
        $this->createQueryBuilder()
            ...
            ->setParameter(
                'variables',
                '{"primaryColor":"#4a1dff","primaryFontColor":"#FFFFFF","secondaryColor":"#76BC21","secondaryFontColor":"#FFFFFF","primaryGradientStartColor":"#0bff24","primaryGradientEndColor":"#1e17f3"}'
            )
